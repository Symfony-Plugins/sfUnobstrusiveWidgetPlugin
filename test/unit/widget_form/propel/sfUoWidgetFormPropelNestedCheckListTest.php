...
require_once($pluginPath.'/lib/widget/propel/sfUoWidgetPropelNestedList.class.php');
require_once($pluginPath.'/lib/widget_form/propel/sfUoWidgetFormPropelNestedCheckList.class.php');
