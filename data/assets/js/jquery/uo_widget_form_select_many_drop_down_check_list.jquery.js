/**
 * Unobstrusive  drop down check list widget using jQuery.
...
;(function($)
{
  $.widget("ui.uoWidgetFormSelectManyDropDownCheckList", {
        ...
        _appendDropContainer: function() {
            ...
            var container = $("<div></div>"); // the actual container
        ...
        _appendControl: function() {
            ...
            // the controls is wrapped in a div
            var wrapper = $("<div/>");
        ...
        _createDropItem: function(index, value, text, checked, indent) {
            ...
            // check indent in label
            var parse = true;
            var strLen   = text.length;
            var indentString = '';
            var i        = 0;
            while(parse && i < strLen)
            {
              parse = text.charCodeAt(i) == 160;
              if (parse)
              {
                indentString += '&nbsp;';
              }
            ...
            {
              item.prepend('<span>'+indentString+'</span>');
            }
        ...
        _formatText: function(selectOptions, firstItemChecksAll, allSelected) {
            ...
            if (firstItemChecksAll && allSelected) {
                ...
                text = jQuery.trim(selectOptions.filter(":first").text());
            } else {
        ...
        _toggleDropContainer: function() {
            ...
            var hide = function() {
                var instance = $.ui.uoWidgetFormSelectManyDropDownCheckList.drop;
                if (null != instance) {
                    ...
                    $.ui.uoWidgetFormSelectManyDropDownCheckList.drop = null;
                    $(document).unbind("click", hide);
                }
            }
            // shows the given drop container instance
            var show = function(instance) {
                if (null != $.ui.uoWidgetFormSelectManyDropDownCheckList.drop) {
                    hide();
                }
                instance.dropWrapper.css({
                ...
                $.ui.uoWidgetFormSelectManyDropDownCheckList.drop = instance;
        ...
        _setSize: function(dropCalculatedSize) {
            ...
            if (dropWidth < controlWidth)
            {
              dropWidth = controlWidth;
            }
    ...
    $.extend($.ui.uoWidgetFormSelectManyDropDownCheckList, {
        defaults: {
            width: null,
            maxDropHeight: null,
