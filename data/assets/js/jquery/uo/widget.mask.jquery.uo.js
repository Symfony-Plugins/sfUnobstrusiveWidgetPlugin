...
(function($)
{
  ...
  $.widget("uo.uoMask",
  {
    ...
    _init: function()
    {
      ...
      $.extend(this, { caret: function(begin, end){ return $.uo.uoMask.caret(self.element, begin, end); } });
      ...
      {
        //in case the user decided to nix a placeholder.
    ...
    _bindEvents: function()
    {
      ...
      function keypressEvent(e)
      {
        ...
        else if ((k >= keyCode.SPACE && k <= 125) || k > 186)
        {
          //typeable characters
      ...
      if (!input.attr("readonly"))
      {
        input
          ...
          .bind('apply.mask', function()
          {
            //changing the value of an input without keyboard input requires re-applying the mask.
            focusText = input.val();
            var pos = self._checkVal();
            self._writeBuffer();
          })
